...
const items = [
  ...
  },
  {
    ...
    render: (extrinsic) => (
      <span>
        ...
        <Link href={`/blocks/${extrinsic.blockNum}`}>
          <a>{extrinsic.blockNum}</a>
        </Link>
      </span>
    ),
  },
  {
    ...
    render: (extrinsic) => (
      <>
        ...
        <CopyClipboard text={extrinsic.extrinsicHash} />
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    render: (extrinsic) => (
      <>
        <Link href={`/accounts/${extrinsic.accountId}`}>
          <a>{extrinsic.accountId}</a>
        </Link>
  ...
  },
  {
    ...
    render: (extrinsic) =>
      extrinsic.success ? (
        ...
        <ExtrinsicResult
          success={false}
          detail={<span>Failed ({extrinsic.error.name})</span>}
        />
      ),
  },
  {
