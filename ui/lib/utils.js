export function formatTimeAgo(time, base = Date.now(), simple = false) {
  ...
  if (passSecs < 1) return "0 sec ago";
  if (passSecs < 60)
    return ""
      .concat(passSecs, " ")
      .concat(1 === passSecs ? "sec" : "secs", " ago");
  if (passSecs < 3600) {
  ...
  if (passSecs < 86400) {
    ...
    return simple
      ? "".concat(hours, " ").concat(1 === hours ? "hr" : "hrs", " ago")
      : ""
          .concat(hours, " ")
          .concat(1 === hours ? "hr" : "hrs")
          .concat(
            0 === mins ? "" : 1 == mins ? " 1 min" : " ".concat(mins, " mins"),
            " ago"
          );
  }
  if (passSecs < 9e4) {
    ...
    return simple
      ? "".concat(days, " ").concat(1 === days ? "day" : "days", " ago")
      : ""
          .concat(days, " ")
          .concat(1 === days ? "day" : "days")
          .concat(
            0 === hours
              ? ""
              : 1 == hours
  ...
  return simple
    ...
    : ""
        ...
        .concat(1 === days ? "day" : "days")
        .concat(
          0 === hours ? "" : 1 == hours ? " 1 hr" : " ".concat(hours, " hrs"),
          " ago"
        );
}
...
export function formatTimeUtc(time) {
  return (
    new Date(time).toISOString().replace(/T/, " ").slice(0, -5) + " (+UTC)"
  );
}
